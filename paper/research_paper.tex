...
\begin{itemize}
    \item \textbf{Reinforcement Learning}~\cite{sutton2018,shabka2022} for adaptive control, but requires online learning
    \item \textbf{Neural Networks}~\cite{narendra1990,gunther2019} for parameter prediction, but limited to specific system types
    \item \textbf{Deep Reinforcement Learning}~\cite{jesawada2022} for PID optimization, but computationally intensive
\end{itemize}
...
\bibitem{shabka2022}
Z. Shabka, M. Enrico, N. Parsons, and G. Zervas, ``One-shot, offline and production-scalable PID optimisation with deep reinforcement learning,'' \textit{arXiv preprint arXiv:2210.13906}, 2022.
...
\bibitem{gunther2019}
J. Günther, E. Reichensdörfer, P. M. Pilarski, and K. Diepold, ``Interpretable PID parameter tuning for control engineering using general dynamic neural networks: An extensive comparison,'' \textit{arXiv preprint arXiv:1905.13268}, 2019.

\bibitem{jesawada2022}
H. Jesawada, A. Yerudkar, C. Del Vecchio, and N. Singh, ``A model-based reinforcement learning approach for PID design,'' \textit{arXiv preprint arXiv:2206.03567}, 2022.
...
The complete implementation is available at: \url{https://github.com/ilyasidk/ml-pid-optimization}
